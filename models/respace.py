...
class SpacedDiffusionDDPM(GaussianDiffusionDDPM):
    ...
    def training_losses_distill(self, model, teacher_model, *args, **kwargs):
        return super().training_losses_distill(self._wrap_model(model), self._wrap_model(teacher_model), *args, **kwargs)
